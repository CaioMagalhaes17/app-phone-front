    ...
    <>
      <Panel id="location" className="mt-5 font-bold">
        <div className="flex flex-row">
          <Text className="text-2xl text-dark dark:text-white flex flex-row gap-5 items-center " as="h1"><IconStreetMap height="50px" width="40px" /> Localização e Contato</Text>
          {isOwner && (
