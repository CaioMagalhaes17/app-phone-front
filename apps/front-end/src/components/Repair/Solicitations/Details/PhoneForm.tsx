      ...
      {!editMode ? (
        <Panel className="w-full font-bold">
          ...
          <div className="flex flex-col mt-6 gap-1 mb-5">
            <Text className="text-dark dark:text-white text-lg" as="h1">Marca - <span className="">{formatPhoneBrand(phoneForm.brand)}</span></Text>
            <Text className="text-dark dark:text-white text-lg" as="h1">Modelo - <span className="">{phoneForm.model}</span></Text>
            ...
            <Text className="text-dark dark:text-white text-lg" as="h1">{phoneQuestions[4].question} - <span className="">{formatUsageTime(phoneForm.usageTime)}</span></Text>
          </div>
        </Panel>
