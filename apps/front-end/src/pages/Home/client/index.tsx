...
import { Button, HSeparator, IconPencil, IconSearch, IconSend, IconStreetMap, Input, Panel, Text } from "@app/ui";
                ...
                <div className="flex flex-row items-center gap-10 justify-center text-center ">
                  <div className="flex-col">
                    ...
                    <div className="flex gap-5 flex-row w-full">
                      <Button onClick={() => navigate('/solicitations/create')} className="btn-primary flex flex-row gap-5 text-xl ml-auto mr-auto mt-10">
                        <IconSend />
                        Solicitar orçamento
                      </Button>
                      <Button onClick={() => navigate('/map')} className="flex flex-row gap-5 btn-outline-primary text-xl ml-auto mr-auto mt-10">
                        <IconSearch />
                ...
                <div className="flex flex-col items-center gap-5 justify-center text-center">
                  <div className="flex-col">
                    <div className="flex flex-row items-center">
                      ...
                      <div className="flex-col">
                        <img className="h-[200px] w-[200px]" src={mainImg} />
                      </div>
                    </div>
                    ...
                    <label className="text-md flex items-center gap-2 block">
                      <input
                        ...
                        style={{ backgroundColor: 'currentcolor' }}
                      />
                      <p className="text-dark dark:text-white-dark font-extrabold mb-2">
                        Solicite orçamentos para todas as lojas mais próximas de você, sem sair de casa!
                      </p>
                    </label>
                    ...
                    <label className="text-md flex items-center gap-2 block">
                      <input
                        ...
                        style={{ backgroundColor: 'currentcolor' }}
                      />
                      <p className="text-dark dark:text-white-dark font-extrabold max-w-2xl mb-2">
                        Procure por produtos e acessórios de celulares!
                      </p>
                    </label>
                    ...
                    <div className="flex gap-2 flex-row w-full">
                      <Button onClick={() => navigate('/solicitations/create')} className="!text-[11px] btn-primary gap-2 flex flex-row ml-auto mr-auto ">
                        <IconSend />
                        Solicitar orçamento
                      </Button>
                      <Button onClick={() => navigate('/map')} className="!text-[11px] flex flex-row gap-2  btn-outline-primary ml-auto mr-auto ">
                        <IconSearch />
                        Procurar lojas próximas
                      </Button>
                    </div>
