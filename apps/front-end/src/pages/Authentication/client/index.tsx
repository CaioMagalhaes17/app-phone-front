      ...
      <div className="relative flex min-h-screen items-center justify-center bg-cover bg-center bg-no-repeat px-6 py-10 sm:px-16">
        <div className="relative w-full max-w-[570px] rounded-md p-2">
          <div className="font-extrabold relative flex flex-col justify-center rounded-md dark:bg-dark px-6 py-10">
            ...
            <button onClick={() => navigate('/signup')} className="rounded-xl mt-10 p-2 w-full flex flex-row border border-[#c4c4c4] hover:bg-[#c4c4c438]">
              <IconUser className="h-[100px] w-[100px] mr-10 ml-5" />
            ...
            <button onClick={() => navigate('/store/signup')} className="mt-10 rounded-xl  p-2 w-full flex flex-row border border-[#c4c4c4] hover:bg-[#c4c4c438]">
              <IconStore className="h-[100px] w-[100px] mr-10 ml-5" />
              <div className="flex flex-col">
