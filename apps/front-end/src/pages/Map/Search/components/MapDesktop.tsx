...
export function MapSearchDesktop() {
  const { onOrderChange, mapStyle, isMapLoaded, clintLocation, radius, navigate, selectedStore, setSelectedStore, storesLoading, stores } = useMapSearchController()
  return (
    <>
