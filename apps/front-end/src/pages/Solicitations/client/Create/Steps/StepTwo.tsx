...
export function StepTwo({ onSubmit, topicSelected, setActiveTab, stepTwoInfos }: { stepTwoInfos?: FieldValues, onSubmit: (data: FieldValues) => void, topicSelected: string, setActiveTab: React.Dispatch<React.SetStateAction<number>> }) {
  return (
    <>
