              ...
              <div className="flex flex-col items-center gap-5 justify-center text-center">
                <div className="flex-col">
                  ...
                  <div className="flex gap-2 flex-row w-full">
                    <Button onClick={() => scrollToSection('services')} className="!text-[11px] btn-primary gap-2 flex flex-row ml-auto mr-auto ">
                      <IconSend />
                      Solicitar orçamento
                    </Button>
                    <Button onClick={() => navigate('/signup')} className="!text-[11px] flex flex-row gap-2  btn-outline-primary ml-auto mr-auto ">
                      <IconSearch />
                      Procurar lojas próximas
                    </Button>
                  </div>
