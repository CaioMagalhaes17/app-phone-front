import { IconWhatsApp, Panel, Text } from "@app/ui";
      ...
      <Panel className="dark:!bg-[#060818] font-extrabold flex flex-col items-center justify-center !shadow-none">
        <div id="about" className="mb-5 max-w-[1100px] w-full">
          ...
          <div className="flex flex-col p-4">
            ...
            <Text className="text-xl dark:text-white-dark text-dark mt-5" as="span">Nosso objetivo é simplificar sua vida, economizar seu tempo e garantir que você tenha acesso às melhores opções para o seu reparo.</Text>
            <Text className="text-xl dark:text-white text-black mt-10" as="span">Se quiser saber mais, entre em contato:</Text>
            <Text className="text-xl dark:text-white text-black " as="span">📧 Email: <Text as="span" className="text-gray-600">caiomagalhaesdefaria@hotmail.com</Text></Text>
            <Text className="text-xl dark:text-white text-black  flex flex-row gap-2 items-center" as="span"><IconWhatsApp />WhatsApp: <Text as="span" className="text-gray-600">(31) 99585-3806 </Text></Text>
          </div>
        </div>
      </Panel>
    </>
